...
<head>
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="ftco-blocks-cover-1">
        <div class="ftco-cover-1" style="background-image: url('images/about_3.jpg');">
            <div class="container">
        ...
        <div class="row">
            ...
            <form action="mail.php" method="POST">
              <div class="form-group row">
                <div class="col-md-6 mb-4 mb-lg-0">
                  <input type="user" class="form-control" id="" name="user_name" placeholder="Введите имя">
                </div>
                <div class="col-md-6">
                  <input type="fam" class="form-control" id="" name="fam_name" placeholder="Введите фамилию">
                </div>
              </div>

              <div class="form-group row">
                <div class="col-md-12">
                  <input type="mail" class="form-control" id="" name="mail_name" placeholder="Email ">
                </div>
              </div>

              <div class="form-group row">
                <div class="col-md-12">
                  <textarea type="sob"  id="" class="form-control"  name="sob_name" placeholder="Напишите ваше сообщение" cols="30" rows="10"></textarea>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-6 mr-auto">
                  <input type="submit" class="btn btn-block btn-primary text-white py-3 px-5 rounded-0" value="ОТПРАВИТЬ">
                </div>
              </div>
            </form>
          </div>
          <div class="col-lg-4 ml-auto">
            <div class="bg-white p-3 p-md-5">
              <h3 class="heading-39291">Наши контакты</h3>
              <ul class="list-unstyled footer-link">
                <li class="d-block mb-3">
                  <span class="d-block text-black small text-uppercase font-weight-bold">Адрес:</span>
                  <span>Ульяновская область, ул.Станкостроителей,д13,кв.5</span></li>
                <li class="d-block mb-3"><span class="d-block text-black small text-uppercase font-weight-bold">Телефон:</span><span>+289647827424</span></li>
                <li class="d-block mb-3"><span class="d-block text-black small text-uppercase font-weight-bold">Email:</span><span>zindfy27@mail.ru</span></li>
              </ul>
            </div>
          </div>
        </div>
